                            ...
                            <div class="accordion nav-justified" id="accordionExample">
                                    ...
                                    <div class="card-header" id="headingOne">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link w-100 collapsed text-uppercase" type="button" data-toggle="collapse"
                                                data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><i class="fas fa-user-cog" style="font-size: 1.5rem; vertical-align: sub;"></i>
                                                {{ __('messages.Users') }}
                                            </button>
                                        </h2>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingTwo">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link w-100 collapsed text-uppercase" type="button" data-toggle="collapse"
                                                data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><i class="fas fa-vote-yea" style="font-size: 1.5rem; vertical-align: sub;"></i>
                                    ...
                                    <div class="card-header" id="headingThree">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link w-100 collapsed text-uppercase" type="button" data-toggle="collapse"
                                                ...
                                                aria-controls="collapseThree"><i class="fas fa-info-circle" style="font-size: 1.5rem; vertical-align: sub;"></i>
